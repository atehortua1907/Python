...
ventana.title("Formularios en Tkinter | Victor Robles Udemy")

#Texto encabezado para
encabezado = Label(ventana, text="Formularios con Tkinter | David Atehortua")
encabezado.config(
    fg="white",
    bg="darkgray",
    font=("Open Sans", 18),
...
#Boton
Label(ventana).grid(row=4, column=1) #para tener una linea de separación entre los campos y el boton
